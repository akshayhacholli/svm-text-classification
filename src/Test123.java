public class Test123
{
	 ...
	 * public svm_model svmTrain( String Filename1 )
	 * {
	 * return null;
	 ...
	 * 
	 * double node_values[][] = new double[ Dataset.size() ][ ]; // jagged array used to store values
	 * int node_indexes[][] = new int[ Dataset.size() ][ ];// jagged array used to store node indexes
	 * double node_class_labels[] = new double[ Dataset.size() ];// store class lavels
	 * 
	 ...
	 * 
	 * svm_model model2 = t123.svmTrain( "Data\\trainData" );
	 * 
	 * t123.evaluate_all_instances( "Data\\trainData", model2 );
	 * 
